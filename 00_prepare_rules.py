...
def main():
    ...
    if problems:
        for problem in problems:
            print(problem)
        finish_stage(state_path, 'prepare_rules', started, status='error', extra={'errors': problems})
        raise SystemExit(2)
    ...
    if issues:
        ...
        finish_stage(state_path, 'prepare_rules', started, status='error', extra={'errors': issues})
        raise SystemExit(2)
